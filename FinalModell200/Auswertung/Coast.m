...
ylabel('N Particles')
title('Island 2')
sgtitle('Spatial Distribution of particles at the coast  by spawn-location \omega=200')
...
ylabel('N Particles')
title('Island 2')
sgtitle('Temporal Distribution of particles at the coast  by spawn-location \omega=200')
